...
const status_adocao_pet_dto_1 = require("./dto/status-adocao-pet.dto");
let PetsController = class PetsController {
    ...
    updateStatus(id, statusPetDto) { return this.petsService.updateStatus(Number(id), statusPetDto); }
    teste(id) {
        return { id, ok: true };
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String,
        status_adocao_pet_dto_1.StatusPetDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PetsController.prototype, "teste", null);
