...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: "O campo nome não pode estar vazio." }),
    (0, class_validator_1.IsString)({ message: "O Nome deve ser Textof" }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "nome", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: "O campo Email não pode estar vazio." }),
...
__decorate([
    ...
    (0, class_validator_1.IsEnum)(client_1.Role, { message: 'Escolha uma das opções INSTITUICAO ou ADOTANTE' }),
    __metadata("design:type", String)
